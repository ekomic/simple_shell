 ...
 */
int fchain(finfo_a1 *finfo, char *buf, size_t *f)
{
	size_t j = *f;
 ...
 * Return: Void
 */
void check_fchain(finfo_a1 *finfo, char *buf, size_t *f, size_t i, size_t len)
{
	size_t j = *f;
 ...
 */
int replace_falias(finfo_a1 *finfo)
{
	int i;
	list_t *node;
	char *f;
 ...
 * Return: 1 if replaced, 0 otherwise
 */
int replace_fvars(finfo_a1 *finfo)
{
	int i = 0;
	list_t *node;
