...
/**
 * clear_finfo - initializes finfo_a1 struct
 * @finfo: struct address
 */
void clear_finfo(finfo_a1 *finfo)
{
	(*finfo).arg = NULL;
	(*finfo).argv = NULL;
	(*finfo).path = NULL;
...
/**
 * set_finfo - initializes finfo_a1 struct
 * @finfo: struct address
 * @av: argument vector
 */
void set_finfo(finfo_a1 *finfo, char **av)
{
	int i = 0;
...
/**
 * free_finfo - frees finfo_a1 struct fields
 * @finfo: struct address
 * @all: true if freeing all fields
 */
void free_finfo(finfo_a1 *finfo, int all)
{
	ffree((*finfo).argv);
	(*finfo).argv = NULL;
	(*finfo).path = NULL;
