 ...
 * Return: the value
 */
char *_fgetenv(finfo_a1 *finfo, const char *name)
{
 ...
 * Return: Always 0
 */
int fpop_env_list(finfo_a1 *finfo)
{
	list_t *node = NULL;
	size_t i;
