 ...
 * Return: bytes read
 */
ssize_t input_buf(finfo_a1 *finfo, char **buf, size_t *len)
{
	ssize_t r = 0;
	size_t len_p = 0;
 ...
 * Return: bytes read
 */
ssize_t get_input(finfo_a1 *finfo)
{
 ...
 * Return: r
 */
ssize_t read_buf(finfo_a1 *finfo, char *buf, size_t *i)
{
	ssize_t r = 0;
 ...
 * Return: s
 */
int _fgetline(finfo_a1 *finfo, char **ptr, size_t *length)
{
